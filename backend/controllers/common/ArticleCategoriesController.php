...
use core\entities\Common\Article\ArticleategoriesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ArticleategoriesController implements the CRUD actions for ArticleCategories model.
 */
class ArticleCategoriesController extends Controller
{
    ...
    {
        $searchModel = new ArticleategoriesSearch();
