...
/* @var $model core\entities\User\Education\TblEducationSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="tbl-education-search">
    ...
    <?php // echo $form->field($model, 'id_edication_level') ?>

    <?php // echo $form->field($model, 'id_univercity') ?>
