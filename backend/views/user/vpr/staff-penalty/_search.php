...
/* @var $model core\entities\User\Vpr\TblStaffPenaltySearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="tbl-staff-penalty-search">
    ...
    <?php // echo $form->field($model, 'id_penalty_type') ?>
    ...
    <?php // echo $form->field($model, 'id_finish_penalty') ?>
