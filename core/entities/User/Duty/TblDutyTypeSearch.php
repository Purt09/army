...
/**
 * TblDutyTypeSearch represents the model behind the search form of `core\entities\User\Duty\TblDutyType`.
 */
class TblDutyTypeSearch extends TblDutyType
{
    /**
     * {@inheritdoc}
     */
