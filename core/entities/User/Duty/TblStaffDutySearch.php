...
/**
 * TblStaffDutySearch represents the model behind the search form of `core\entities\User\Duty\TblStaffDuty`.
 */
class TblStaffDutySearch extends TblStaffDuty
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['unique_id', 'last_update', 'uuid_t', 'rr_name', 'r_icon', 'date_start', 'date_end'], 'safe'],
            [['id', 'id_io_state', 'record_fill_color', 'record_text_color', 'id_duty_type', 'id_staff'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'id_duty_type' => $this->id_duty_type,
