...
/**
 * TblMilitaryRankSearch represents the model behind the search form of `core\entities\User\TblMilitaryRank`.
 */
class TblMilitaryRankSearch extends TblMilitaryRank
{
    /**
     * {@inheritdoc}
     */
