...
/**
 * TblPenaltyTypeSearch represents the model behind the search form of `core\entities\User\Vpr\TblPenaltyType`.
 */
class TblPenaltyTypeSearch extends TblPenaltyType
{
    /**
     * {@inheritdoc}
     */
