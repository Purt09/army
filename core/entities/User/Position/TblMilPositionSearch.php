...
/**
 * TblMilPositionSearch represents the model behind the search form of `core\entities\User\Position\TblMilPosition`.
 */
class TblMilPositionSearch extends TblMilPosition
{
    /**
     * {@inheritdoc}
     */
