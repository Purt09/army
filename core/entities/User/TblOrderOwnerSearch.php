...
/**
 * TblOrderOwnerSearch represents the model behind the search form of `core\entities\User\TblOrderOwner`.
 */
class TblOrderOwnerSearch extends TblOrderOwner
{
    /**
     * {@inheritdoc}
     */
