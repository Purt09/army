...
/**
 * TblConferenceRankSearch represents the model behind the search form of `core\entities\User\Science\TblConferenceRank`.
 */
class TblConferenceRankSearch extends TblConferenceRank
{
    /**
     * {@inheritdoc}
     */
