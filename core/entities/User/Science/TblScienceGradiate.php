...
/**
 * This is the model class for table "tbl_science_gradiate".
 *
...
class TblScienceGradiate extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(TblStaffScienceGraduate::className(), ['id_science_graduate' => 'id']);
    }
}
