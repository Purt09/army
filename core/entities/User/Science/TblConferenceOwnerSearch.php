...
/**
 * TblConferenceOwnerSearch represents the model behind the search form of `core\entities\User\Science\TblConferenceOwner`.
 */
class TblConferenceOwnerSearch extends TblConferenceOwner
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['unique_id', 'last_update', 'uuid_t', 'rr_name', 'r_icon', 'name', 'short_name'], 'safe'],
