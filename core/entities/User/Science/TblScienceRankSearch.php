...
/**
 * TblScienceRankSearch represents the model behind the search form of `core\entities\User\Science\TblScienceRank`.
 */
class TblScienceRankSearch extends TblScienceRank
{
    /**
     * {@inheritdoc}
     */
