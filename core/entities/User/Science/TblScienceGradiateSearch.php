...
/**
 * TblScienceGradiateSearch represents the model behind the search form of `core\entities\User\Science\TblScienceGradiate`.
 */
class TblScienceGradiateSearch extends TblScienceGradiate
{
    /**
     * {@inheritdoc}
     */
