...
/**
 * TblEducationLevelSearch represents the model behind the search form of `core\entities\User\Education\TblEducationLevel`.
 */
class TblEducationLevelSearch extends TblEducationLevel
{
    /**
     * {@inheritdoc}
     */
