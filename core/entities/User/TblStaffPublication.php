...
class TblStaffPublication extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['unique_id', 'id_io_state', 'uuid_t', 'rr_name', 'id_staff', 'id_science_magazine', 'publication_name', 'pages', 'out_data', 'expert_zakl_number'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_staff' => 'Id Staff',
            'id_science_magazine' => 'Id Science Magazine',
            'publication_name' => 'Publication Name',
            'pages' => 'Pages',
            'out_data' => 'Out Data',
            'expert_zakl_number' => 'Expert Zakl Number',
            'scan_title' => 'Scan Title',
            'scan_expert' => 'Scan Expert',
            'scan_magazine' => 'Scan Magazine',
