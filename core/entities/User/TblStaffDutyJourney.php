...
/**
 * This is the model class for table "tbl_staff_duty_journey".
 *
 ...
 */
class TblStaffDutyJourney extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['unique_id', 'id_io_state', 'uuid_t', 'rr_name', 'id_staff', 'date_start', 'date_end', 'id_city', 'organization'], 'required'],
            [['unique_id', 'uuid_t', 'rr_name', 'r_icon', 'order_number', 'organization'], 'string'],
            [['last_update', 'date_start', 'date_end', 'order_date'], 'safe'],
            [['id_io_state', 'record_fill_color', 'record_text_color', 'id_staff', 'id_city', 'id_order_owner'], 'default', 'value' => null],
            [['id_io_state', 'record_fill_color', 'record_text_color', 'id_staff', 'id_city', 'id_order_owner'], 'integer'],
            [['unique_id'], 'unique'],
            [['uuid_t'], 'unique'],
