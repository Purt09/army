...
/**
 * TblStaffVacationSearch represents the model behind the search form of `core\entities\User\Vacation\TblStaffVacation`.
 */
class TblStaffVacationSearch extends TblStaffVacation
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['unique_id', 'last_update', 'uuid_t', 'rr_name', 'r_icon', 'date_start', 'date_end', 'order_number', 'order_date'], 'safe'],
            [['id', 'id_io_state', 'record_fill_color', 'record_text_color', 'id_vacation_type', 'id_staff', 'id_order_owner'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'id_vacation_type' => $this->id_vacation_type,
