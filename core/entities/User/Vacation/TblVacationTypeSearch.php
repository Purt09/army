...
/**
 * TblVacationTypeSearch represents the model behind the search form of `core\entities\User\Vacation\TblVacationType`.
 */
class TblVacationTypeSearch extends TblVacationType
{
    /**
     * {@inheritdoc}
     */
