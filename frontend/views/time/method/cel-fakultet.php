...
$this->title = "Целевые показатели факультета";
    ...
    <div class="col-md-4 col-sm-6">
        <div class="pricingTable">
            ...
            <ul class="pricing-content" data-heading="">
                <li><i></i>ЦЕЛЕВЫЕ ПОКАЗАТЕЛИ 5 ФАКУЛЬТЕТА
                </li>
            </ul>
            <div class="pricingTable-signup">
                <a href="http://5f.vka/file_manager/files/fakultet/5_fak_CP_na_2020_god_itog_260320.doc"><span>Открыть</span></a>
            </div>
        </div>
    </div>
</div>
