...
/* @var $model core\entities\User\Science\TblScienceConferenceSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="tbl-science-conference-search">
    ...
    <?php // echo $form->field($model, 'id_conference_owner') ?>

    <?php // echo $form->field($model, 'id_conference_rank') ?>
