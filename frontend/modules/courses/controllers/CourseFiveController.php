...
class CourseFiveController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'roles' => ['course55', 'admin', RbacHelpers::$OFFICER],
                    ],
                ],
            ],
        ];
    ...
    public function actionIndex()
    {
        ...
        $news = NewsPublications::find()->where(['course55' => 1])->with('articles')->orderBy('id desc')->all();
        $users = RbacHelpers::getByTwoRole(RbacHelpers::$COURSE55, RbacHelpers::$COURSE_MAIN);
    ...
    {
        $users = RbacHelpers::getByTwoRole(RbacHelpers::$COURSE55, RbacHelpers::$CADET);
        ...
        return $this->render('users', [
            'title' => 'Управление пользователями 55 курса',
            'controller' => 'course-five',
            'provider' => $provider
        ]);
    }
    ...
    public function actionNews()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, 'course55');
    ...
    {
        $model = Page::find()->where(['alias' => 'main_55course'])->one();
        ...
        return $this->render('main', [
            'model' => $model,
            'title' => 'Управление главной 55 курса'
        ]);
    }
