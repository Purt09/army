...
class CourseFreeController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $users = RbacHelpers::getByTwoRole(RbacHelpers::$COURSE53, RbacHelpers::$COURSE_MAIN);
    ...
    public function actionNews()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, 'course53');
    ...
    {
        $users = RbacHelpers::getByTwoRole(RbacHelpers::$COURSE53, RbacHelpers::$CADET);
        ...
        return $this->render('users', [
            'title' => 'Управление пользователями 53 курса',
    ...
    {
        $model = Page::find()->where(['alias' => 'main_53course'])->one();
        ...
        return $this->render('main', [
            'model' => $model,
            'title' => 'Управление главной 53 курса'
        ]);
    }
