 ...
 */
use frontend\modules\fileManager\Assets;
...
<style>
    ...
    a.backgo:hover { background: rgb(232,95,76); } /* при наведении курсора мышки */
    a.backgo:active { background: rgb(152,15,0); } /* при нажатии */
</style>
<a class="backgo" href="<?= Yii::$app->params['frontendHostInfo'] ?>">
    На главную
</a>
</body>
</html>
