...
'controllerMap' => [
        'elfinder' => [
            ...
            'roots' => [
                ...
                [
                    'class' => 'frontend\modules\fileManager\volume\UserPath',
                    'path'  => 'files/user_{id}',
                    'name'  => 'My Documents'
                ],
                [
...
'controllerMap' => [
        'elfinder' => [
			'class' => 'frontend\modules\fileManager\PathController',
			'access' => ['@'],
			'root' => [
				'path' => 'files',
				'name' => 'Files'
...
На данный момент реализованно использование только LocalFileSystem хранилища (frontend\modules\fileManager\volume\Local и frontend\modules\fileManager\volume\UserPath)
для использования остальных вам прийдётся всё настраивать через frontend\modules\fileManager\volume\Base
...
'controllerMap' => [
        'elfinder' => [
            'class' => 'frontend\modules\fileManager\Controller',
            //'plugin' => ['\frontend\modules\fileManager\plugin\Sluggable'],
            'plugin' => [
                [
...
```php
use frontend\modules\fileManager\InputFile;
use frontend\modules\fileManager\ElFinder;
...
frontend\modules\fileManager\Assets::noConflict($this);
