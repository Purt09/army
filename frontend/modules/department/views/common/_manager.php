...
<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <a class="box_link" href="<?= \yii\helpers\Url::to(["/department/$controller/article", 'unit_id' => $unit_id, 'category_id' => 2]) ?>">
                <div class="info-box bg-light-blue">
                    <span class="info-box-icon"><i class="fa fa-pencil"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <a class="box_link" href="<?= \yii\helpers\Url::to(["/department/$controller/article", 'unit_id' => $unit_id, 'category_id' => 1]) ?>">
                <div class="info-box bg-light-blue">
                    <span class="info-box-icon"><i class="fa fa-pencil"></i></span>
